...
*/
        switch (item.getItemId())
        {
            ...
            case R.id.Share:
                //Toast.makeText(getApplicationContext(),item.getTitle(),Toast.LENGTH_SHORT).show();
                Intent intent1 = new Intent(this, Share.class);
            ...
            case R.id.Helpfeedback:
                Intent intent3 = new Intent(this, Helpfeedback.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.loginSigup) {
            Intent in = new Intent(MainActivity.this,LoginSignup.class);
